...
found:
  ...
  // Assign tid to 0 for parent process
  p->tid = 0;
...
clone(void *stack, int size)
{
  ...
  //use same page table from process to create thread
...
exit(int status)
{
  ...
  // close all files only for parent process
  if (p->tid ==0) {
